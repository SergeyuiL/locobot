...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image> RealScenseSyncPolicy;
...
public:
	...
	image_transport::Publisher seg_result_pub;
	message_filters::Subscriber<sensor_msgs::Image> rgb_sub;
	message_filters::Subscriber<sensor_msgs::Image> dep_align_sub;
	boost::shared_ptr<message_filters::Synchronizer<RealScenseSyncPolicy> > sync;
...
public:
	...
	void realsenceCallback(const ImageConstPtr& imageRGB, const ImageConstPtr& imageDepAlgin);
